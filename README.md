...
[![pub package](https://img.shields.io/pub/v/flutter_lwa_hw.svg)](https://pub.dartlang.org/packages/flutter_lwa_hw)
...
**This is an updated version of flutter_lwa compatible with Flutter 3.7.2+ with modern v2 plugin API.**
...
```dart
import 'package:flutter_lwa_hw/lwa.dart';
